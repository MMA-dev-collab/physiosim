                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {data.image_url && (
                            <div className="lg:col-span-1">
                                <ImageWithWatermark src={data.image_url} alt="Observation" className="w-full rounded-lg shadow-md border border-slate-200" watermarkEnabled={false} />
                            </div>
                        )}
                        ...
                        {hasImage && (
                            <div className="w-full lg:w-1/2 shrink-0">
                                <div className="rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                                    <ImageWithWatermark src={data.image_url} alt="Palpation Reference" className="w-full h-auto object-cover" watermarkEnabled={false} />
                                </div>
                            </div>
                        )}
                            ...
                            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                                {e.image_url ? (
                                    <div className="bg-black/5 rounded-lg overflow-hidden border border-black/10 flex items-center justify-center">
                                        <ImageWithWatermark src={e.image_url} alt={e.modality} className="max-h-64 object-contain" watermarkEnabled={false} />
                                    </div>
                                ) : (
